...
import { Lock, User, Eye, EyeOff, ArrowRight, KeyRound, Award } from 'lucide-react';
...
export const LoginPage: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    e.preventDefault();
    if (!username) {
      toast.error('Please enter your administrator username or email');
      return;
    }
  ...
  const fillDemoCredentials = () => {
    ...
    toast.info('Filled Username: admin | Password: admin123');
  };
        ...
        <div className="bg-white dark:bg-slate-900 rounded-3xl p-8 border border-slate-200 dark:border-slate-800 shadow-xl relative">
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="admin"
                  className="w-full pl-10 pr-4 py-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-sm font-semibold text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-brand-900 focus:ring-1 focus:ring-brand-900"
                />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input
                  ...
                  placeholder="••••••••"
                  className="w-full pl-10 pr-10 py-3 bg-slate-50 dark:bg-slate-950 border border-slate-200 dark:border-slate-800 rounded-xl text-sm font-semibold text-slate-900 dark:text-white placeholder-slate-400 focus:outline-none focus:border-brand-900 focus:ring-1 focus:ring-brand-900"
                />
                <button
                  type="button"
          ...
          <div className="mt-6 pt-4 border-t border-slate-100 text-center">
            ...
            >
              ...
              <span>Fill Credentials (admin / admin123)</span>
            </button>
          </div>
        </div>
        ...
        <div className="fixed inset-0 z-50 bg-slate-900/60 backdrop-blur-sm flex items-center justify-center p-4">
          ...
          >
            ...
            <p className="text-xs text-slate-500 mb-4">
              Enter your administrator username or registered email address to receive password reset instructions.
            </p>
